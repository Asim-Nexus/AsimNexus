...
from core.mesh.multi_mesh_router import (
    MeshType,
    MeshProfile,
    MultiMeshRouter,
...
from core.mesh.node_registry import NodeRegistry, TrustLevel, NodeStatus, get_node_registry
from core.mesh.kademlia_dht import KademliaDHT, NodeID, DHTNode, get_kademlia_dht
from core.mesh.crdt_sync import CRDTStore, get_crdt_store
from core.mesh.bootstrap import BootstrapService, get_bootstrap_service
...
def create_local_node_set(
    ...
    for i in range(num_nodes):
        ...
        if include_bootstrap:
            from core.mesh.bootstrap import BootstrapService
