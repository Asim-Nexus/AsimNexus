...
def monitor():
    ...
    from asim_tools.system.system_monitor import SystemMonitor
    mon = SystemMonitor()
...
class TestSystemMetrics:
    ...
    def test_create_system_metrics(self):
        ...
        from asim_tools.system.system_monitor import SystemMetrics
        sm = SystemMetrics(
            timestamp=1000.0,
            cpu_percent=50.0,
            cpu_count=8,
...
class TestGetSystemMonitor:
    ...
    def test_get_system_monitor_returns_instance(self):
        ...
        from asim_tools.system.system_monitor import get_system_monitor
