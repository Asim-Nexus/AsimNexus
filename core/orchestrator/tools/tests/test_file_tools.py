...
try:
    from asim_tools.system.file_tools import FileTools, FileOperation, FileOperationResult
except ImportError:
    # asim_tools is an external dependency; tests will be skipped at runtime if missing
    FileTools = None  # type: ignore
    FileOperation = None  # type: ignore
    FileOperationResult = None  # type: ignore
