    ...
    * Maintain an in-memory audit buffer of recent executions.
    ...
    def _register_openclaw_tools(self) -> None:
        ...
        * Handler reference to the concrete implementation
        ...
        from core.orchestrator.tools.system.file_tools import FileTools
        from core.orchestrator.tools.system.process_tools import ProcessTools
        from core.orchestrator.tools.system.system_monitor import get_system_monitor
        from core.orchestrator.tools.system.clipboard_tools import get_clipboard_tools
        from core.orchestrator.tools.system.notification_tools import get_notification_tools
        from core.orchestrator.tools.microkernel import MicroKernelInterface
