...
async def test_imports():
    ...
    try:
        ...
        from core.gateway.unified_llm_gateway import unified_llm_gateway
    except ImportError:
        # Use mock if not available
        pass
    
    try:
        from core.agents.unified_agent_system import UnifiedAgentSystem
    except ImportError:
        # Use mock if not available
        pass
    ...
    try:
        from core.gateway.openai_connector import openai_connector
