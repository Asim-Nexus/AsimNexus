...
from core.agents.economy_agent import economy_agent, initialize_economy_agent
from core.agents.health_agent import health_agent, initialize_health_agent
from core.agents.schedule_agent import schedule_agent, initialize_schedule_agent
from app import app
...
class TestMVP(unittest.TestCase):
    ...
    def test_unified_server_app(self):
        self.assertEqual(app.title, "AsimNexus World OS")
