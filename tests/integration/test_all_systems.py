...
class TestDeltaTEngine:
    ...
    async def test_database_tables_created(self):
        ...
        if integration.local_db is not None:
            assert integration.local_db is not None
        else:
            pytest.skip("local_db not configured, skipping table assert")
...
class TestAgentSystem:
    ...
    def test_digital_twin_creation(self):
        ...
        from core.agents.digital_twin import get_human_digital_twin, TwinCapability
    ...
    def test_twin_learning(self):
        ...
        from core.agents.digital_twin import get_human_digital_twin
    ...
    async def test_agent_matching(self):
        ...
        from core.agents.agent_matching import get_agent_matcher
        from core.agents.digital_twin import get_human_digital_twin, TwinCapability
...
class TestAdvancedFeatures:
    ...
    def test_consensus_engine(self):
        """Test BFT consensus"""
        pytest.skip("BFT consensus replaced by founder clones ensemble consensus")
