...
def reset_economy():
    ...
    from economy.wallet import reset_wallet_engine
    from economy.tokens import reset_token_registry
    from economy.escrow import reset_escrow_engine
    from economy.marketplace import reset_marketplace_engine
    from economy.staking import reset_staking_engine
    reset_wallet_engine()
