...
from governance.governance_audit import _AUDIT_DB_PATH
from governance.blockchain_constitution_anchor import _ANCHOR_DB_PATH
from security.power_balance_constitution import _POWER_BALANCE_DB_PATH
...
def reset_governance():
    ...
    from governance.governance_audit import reset_governance_audit
    from governance.blockchain_constitution_anchor import reset_constitution_anchor
    from governance.governance_clone_bridge import reset_governance_clone_bridge
    from security.power_balance_constitution import reset_power_balance
