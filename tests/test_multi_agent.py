...
try:
    from agents.company.ceo_agent import CEOAgent
    from agents.company.architect_agent import ArchitectAgent
    from agents.company.devops_agent import DevOpsAgent
    from agents.company.marketing_agent import MarketingAgent
