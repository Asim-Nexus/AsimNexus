...
def test_sync_priority_enum():
    ...
    from mesh.offline_sync_engine import SyncPriority
...
def test_sync_operation():
    ...
    from mesh.offline_sync_engine import SyncOperation, SyncPriority
    op = SyncOperation(
        id="test_001",
        crdt_id="test_crdt",
        operation="add"
...
def test_sync_status():
    ...
    from mesh.offline_sync_engine import SyncStatus
    status = SyncStatus()
