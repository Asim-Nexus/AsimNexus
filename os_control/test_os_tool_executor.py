...
def mock_registry():
    ...
    from os_control.tool_registry import ToolRegistry, ToolRegistration, RiskLevel
...
def mock_capability_matrix():
    ...
    from os_control.capability_matrix import CapabilityMatrix
...
def executor(mock_registry, mock_capability_matrix, tmp_path):
    ...
    from os_control.os_tool_executor import OSToolExecutor
...
class TestToolVerdict:
    ...
    def test_enum_values(self):
        from os_control.tool_registry import ToolVerdict
...
class TestToolCallRecord:
    ...
    def test_create_record(self):
        from os_control.os_tool_executor import ToolCallRecord
...
class TestGetOSToolExecutor:
    ...
    def test_get_os_tool_executor_returns_instance(self):
        ...
        from os_control.os_tool_executor import get_os_tool_executor, OSToolExecutor
