...
class MeshNode:
    ...
    async def _start_bootstrap(self) -> bool:
        ...
        try:
            from mesh.bootstrap import get_bootstrap_service
    ...
    async def _start_discovery(self) -> bool:
        ...
        try:
            from mesh.autodiscovery import get_auto_discovery
    ...
    async def _start_relay(self) -> bool:
        ...
        try:
            from mesh.relay import get_relay_service
    ...
    async def _start_multihop(self) -> bool:
        ...
        try:
            from mesh.multi_hop_router import get_multi_hop_router
    ...
    async def _start_mesh_routing(self) -> bool:
        ...
        try:
            ...
            from mesh.p2p_integration import patch_route_through_mesh
    ...
    async def _send_auto(
        ...
        if self._hole_puncher:
            ...
            if peer_endpoint:
                from mesh.hole_punching import PunchEndpoint
    ...
    async def _on_punch_request(
        ...
        if self._transport:
            from mesh.p2p_transport import PeerInfo
