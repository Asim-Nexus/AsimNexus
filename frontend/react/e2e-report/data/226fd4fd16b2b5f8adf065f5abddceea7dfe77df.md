...
- Name: navigation.spec.js >> Route Navigation — All Routes Render >> should render Legacy: /world-os → OS (/world-os) without crash
- Location: e2e\navigation.spec.js:52:9

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/world-os
Call log:
  - navigating to "http://localhost:3000/world-os", waiting until "domcontentloaded"
