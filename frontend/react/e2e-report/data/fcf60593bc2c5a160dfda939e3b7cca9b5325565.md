...
```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/this-route-does-not-exist-xyz
Call log:
  - navigating to "http://localhost:3000/this-route-does-not-exist-xyz", waiting until "domcontentloaded"
