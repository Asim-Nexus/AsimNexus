...
- Name: chat.spec.js >> Chat / Smart Routing Flow >> should type a message and send it
- Location: e2e\chat.spec.js:24:5
...
Call log:
  - waiting for locator('textarea.odysseus-input-field, textarea, input[type="text"]').first()
