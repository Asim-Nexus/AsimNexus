...
import { teamsAPI, userProfileAPI } from '../../api/asimnexus';
...
function TeamDetail({ teamId, onBack }) {
    ...
    const handleInvite = async () => {
        ...
        try {
            ...
            if (res.data?.success) {
                setSuccess(`Invited ${res.data.display_name || inviteEmail} to the team`);
                setInviteEmail('');
    ...
    if (loading) {
        return (
            <div style={styles.container}>
                <div style={styles.backBtn} onClick={onBack}>← Back to Teams</div>
    ...
    return (
        <div style={styles.container}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 24 }}>
                ...
                <div>
                    ...
                    <div style={{ fontSize: '0.78rem', opacity: 0.5 }}>
                        ...
                        {' · '}
                        <span style={styles.badge(team.member_role)}>{team.member_role}</span>
                    </div>
                </div>
                {canManage && !editMode && (
                    <button style={{ ...styles.btnSecondary, marginLeft: 'auto' }} onClick={handleEdit}>
                        ✏️ Edit
                    </button>
                )}
            </div>
            ...
            {/* Edit Team Form */}
            {editMode && (
                <div style={{ ...styles.card, cursor: 'default', marginBottom: 20 }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                        ...
                        <div>
                            ...
                            <textarea style={styles.textarea} value={editDesc} onChange={e => setEditDesc(e.target.value)} />
                        </div>
                        <div>
                            <div style={styles.fieldLabel}>Icon (emoji)</div>
                            <input style={styles.input} value={editIcon} onChange={e => setEditIcon(e.target.value)} maxLength={2} />
                        </div>
            ...
            {/* Description */}
            {team.description && (
                <div style={{ ...styles.card, cursor: 'default', marginBottom: 16, padding: 16 }}>
                ...
                <div style={{ ...styles.card, cursor: 'default', marginBottom: 16 }}>
                    ...
                    <div style={{ display: 'flex', gap: 8, alignItems: 'flex-end' }}>
                        <div style={{ flex: 1 }}>
                            ...
                            <input style={styles.input} placeholder="user@example.com"
                ...
                <div style={styles.modalOverlay} onClick={() => setShowCreate(false)}>
                    <div style={styles.modal} onClick={e => e.stopPropagation()}>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
                            <div>
                                <div style={styles.fieldLabel}>Team Name</div>
                                <input style={styles.input} placeholder="My Team"
                                    value={createName} onChange={e => setCreateName(e.target.value)}
                                    onKeyDown={e => e.key === 'Enter' && handleCreateTeam()} />
                            </div>
                            <div>
                                <div style={styles.fieldLabel}>Description (optional)</div>
                                <textarea style={styles.textarea} placeholder="What's this team for?"
                            ...
                            <div style={{ display: 'flex', gap: 8, marginTop: 8 }}>
                                <button style={styles.btn} onClick={handleCreateTeam}>Create Team</button>
                                <button style={styles.btnSecondary} onClick={() => setShowCreate(false)}>Cancel</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                {teams.map(team => (
                    <div key={team.id} style={{
                        ...styles.card,
                        ...(hoveredId === team.id ? styles.cardHover : {}),
                    }}
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
                            ...
                            <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                                ...
                                <span style={styles.badge(team.member_role || 'member')}>
