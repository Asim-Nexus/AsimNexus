...
interface AsimNexusIconProps {
    size?: number;
    color?: string;
}

const AsimNexusLogo: React.FC<AsimNexusLogoProps> = ({
    size = 64,
    pulsePhase = 0,
    showGlow = true,
    className = ''
...
export const AsimNexusIcon: React.FC<AsimNexusIconProps> = ({ size = 24, color: _color = '#667eea' }) => (
